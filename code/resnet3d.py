...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.PLE1 = PLE_Module(128, (self.resize // 4) * (self.resize // 4), s_ratio=8, d_ratio=8)
        self.PLE2 = PLE_Module(256, (self.resize // 8) * (self.resize // 8), s_ratio=8, d_ratio=8)
        self.PLE3 = PLE_Module(512, (self.resize // 16) * (self.resize // 16), s_ratio=8, d_ratio=8)
...
def resnet50(args, **kwargs):
    model = ResNet(Bottleneck, [3, 4, 6, 3], get_inplanes(), args, **kwargs)
    return model
